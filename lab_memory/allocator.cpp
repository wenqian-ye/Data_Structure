...
void Allocator::loadRooms(const string& file)//called  by constructor
{
    // Read in rooms
    fileio::loadRooms(file);
    roomCount=fileio::getNumRooms();//M initialize roomCount
